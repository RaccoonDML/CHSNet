...
def parse_args():
    ...
    parser.add_argument('--origin-dir', default='./DATASET/UCF-QNRF_ECCV18',
                        help='original data directory')
    parser.add_argument('--data-dir', default='./DATASET/QNRF-trainfull-test-dmapfix15',
    ...
    for phase in ['Train', 'Test']:
        ...
        if phase == 'Train':
            ...
            for im_path in im_list:
                ...
                dmap = generate_dmap_from_point(im, points).T
                dmap_save_path = im_save_path.replace('.jpg', '_dmap.npy')
                np.save(dmap_save_path, dmap)